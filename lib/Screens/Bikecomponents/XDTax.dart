...
class XDTax extends StatelessWidget {
  XDTax({
  ...
  Widget build(BuildContext context) {
    DateTime date=DateTime.parse(bike.taxDue);
    return Scaffold(
      appBar: AppBar(
        leading: PageLink(
            links: [
...
const String _svg_wfqzw4 =
    '<svg viewBox="282.5 328.5 1.0 64.0" ><path transform="translate(282.5, 328.5)" d="M 0 0 L 0 64" fill="none" stroke="#707070" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
