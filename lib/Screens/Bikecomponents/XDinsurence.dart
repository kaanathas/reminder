...
class XDinsurence extends StatelessWidget {
  XDinsurence({
    Key? key, required this.bike,
  }) : super(key: key);
  final Bike bike;
  ...
  Widget build(BuildContext context) {
    DateTime date=DateTime.parse(bike.insuranceDue);
    return Scaffold(
      appBar: AppBar(
        leading: PageLink(
            links: [
          ...
          children: <Widget>[
            ...
            RaisedButton(
                ...
                onPressed: () {
                  ...
                  bike.insuranceDue=date.toString();
...
const String _svg_rjw4b2 =
    '<svg viewBox="281.5 328.5 1.0 64.0" ><path transform="translate(281.5, 328.5)" d="M 0 0 L 0 64" fill="none" stroke="#707070" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
