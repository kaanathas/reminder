...
class XDService extends StatelessWidget {
  XDService({
  ...
  Widget build(BuildContext context) {
    DateTime date=DateTime.parse(bike.serviceDue);
    return Scaffold(
      appBar: AppBar(
        leading: PageLink(
            links: [
...
const String _svg_2xhyus =
    '<svg viewBox="282.5 289.5 1.0 64.0" ><path transform="translate(282.5, 289.5)" d="M 0 0 L 0 64" fill="none" stroke="#707070" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
